...
class BalanceSheetController extends Controller
{
    ...
    function getMultipleBalanceSheet($arrDate = []){
        $assetList = $this->getData('1,2,3,4,5,14,16',$arrDate,true);
        $liabilityList = $this->getData('7,8,15',$arrDate,false);
        $equityList = $this->getData('9',$arrDate,true);
        $result = [
            'is_error' => false,
    ...
    function getData($id = '()', $arrDate = [], $isDebitMinusCredit = true){
        try{
            // Get account type
