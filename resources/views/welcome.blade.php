        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12"><br>
                    <div class="card card-primary" style="border: 2px solid #1fa8e0;background-image:url(img/icons/border-all.png);background-size: 100% 100%;">
                        ...
                        <div class="row" style="padding: 1%;">
                            <div class="col-md-1 d-none d-sm-none d-md-block">
                                {{-- <img id="flower-img" src="img/icons/stat-flower.png"> --}}
                            </div>
                            <div class="col-md-4">
