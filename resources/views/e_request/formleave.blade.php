...
<form id="{{ $frm_id }}" action="ere_insert_formleave" method="post">
    ...
    <div class="row" style="margin-top:10px;">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-sm-4">
                    <p class="inputinfokh">ម៉ោង </p>
                    <p style="margin-top:-15px;"> Hour</p>
                </div>
                <div class="col-sm-8">
                    <div class="input-group">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-sm-12">
                    <p class="during">ជាអ្នកទទួលជំនួស ៕</p>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4" align="center">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="during">ឈ្មោះ/Name  : <?php echo(isset($approve_by))?'<b>'.$approve_by.'</b>':'...............';?></p>
                    <p class="during">​កាលបរិច្ឆេទ  : <?php echo (isset($approve_date))?util::conv_datetime($approve_date):'..................'; ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4" align="center">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="during">ឈ្មោះ/Name  : <?php echo(isset($pending_by))?'<b>'.$pending_by.'</b>':'...............';?></p>
                    <p class="during">​កាលបរិច្ឆេទ  : <?php echo (isset($pending_date))?util::conv_datetime($pending_date):'..................'; ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4" align="center">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="during">ឈ្មោះ/Name  : <?php echo(isset($req_by))?'<b>'.$name.'</b>':'...............';?></p>
                    <p class="during">​កាលបរិច្ឆេទ  : <?php echo (isset($create_date))?util::conv_datetime($create_date):'..................'; ?></p>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <p class="during">កំណត់ចំណំា/Note:</p>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
