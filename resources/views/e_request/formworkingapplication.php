    ...
    <div class="container-fluid">
        ...
        @csrf
                            ...
                            <table class="table" border=1  style="text-align:​ center;border-color: black;padding:0px">
                                <tr >
                                    <td class="style_td" style="width:110px;​​ ​text-align:​center !important; background:#dfe6e9;">
                                        <center> <p​ class="word">១ -​ ឈ្មោះ</p></center>
                                    </td>
                                ...
                                <tr >
                                    <td class="style_td" style="width:110px;​​ ​text-align:​ center!important; background:#dfe6e9;">
                                        <center> <p​ class="word">២ -​ ឈ្មោះ</p></center>
                                    </td>
                                    <td class="style_td" style="width:140px;">
                                        <input type="text" name="relative_name[]" class="form-control" >
                                    </td>
                                ...
                                <tr >
                                    <td class="style_td" style="width:110px;​​ ​text-align:​ center!important; background:#dfe6e9;">
                                        <center> <p​ class="word">៣ -​ ឈ្មោះ</p></center>
                                    </td>
                                    <td class="style_td" style="width:140px;">
                                        <input type="text" name="relative_name[]" class="form-control" >
                                    </td>
            ...
            <div class="col-12">
                <table class="table" border=1 style="border-color: black;">
                       <tr>
                           <td class="style_td" style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">ឈ្មោះក្រុមហ៊ុន</p></td>
                           <td class="style_td" colspan="2" ​​style=" width:300px;"> <input type="text" name="exp_company_name[]" class="form-control" ></td>
                           <td class="style_td"​ ​style=" width:100px;text-align:right;background:#dfe6e9;"><p​ class="word">ចំនួនបុគ្កលិក</p></td>
                           <td class="style_td"​​ style="width:200px"> <input type="number" min="0" step="1" name="exp_staff_count[]" class="form-control" ></td>
                       </tr>
                       <tr>
                           <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">អាស័យដ្ឋាន / លេខទូរសព្ទ</p></td>
                           <td class="style_td" colspan="4" > <input type="text" name="exp_phone[]" class="form-control" ></td>

                       </tr>
                       <tr>
                            <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">ប្រភេទអាជីវកម្ម</p></td>
                           <td class="style_td" colspan="4" > <input type="text" name="exp_business_type[]" class="form-control" ></td>

                       </tr>
                       <tr>
                            <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">ប្រភេទស្ថាប័ន</p></td>
                       ...
                       <tr>
                            <td class="style_td" style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">មុខតំណែង</p></td>
                       ...
                       <tr>
                           <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">កាលបរិច្ឆេទចាប់ផ្តើម</p></td>
                           <td class="style_td" style=" width:350px;"><input type="date" name="exp_start_date[]" class="form-control" ></td>
                           <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">កាលបរិច្ឆេទចាកចាញ</p></td>
                           <td class="style_td" colspan="2" style=" width:350px;"><input type="date" name="exp_end_date[]" class="form-control" ></td>
                       </tr>
                       <tr>
                            <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">ប្រាក់បៀរត្សរ៏ចាប់ផ្តើម</p></td>
                            <td class="style_td" style=" width:300px;"><input type="text" name="exp_start_salary[]" class="form-control" ></td>
                            <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">ប្រាក់បៀរត្សរ៏ចុងក្រោយ</p></td>
                            <td class="style_td" colspan="2"><input type="text" name="exp_end_salary[]" class="form-control" ></td>
                       </tr>
                       <tr>
                            <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">ឈ្មោះអ្នកគ្រប់គ្រងផ្ទាល់</p></td>
                            <td class="style_td" style=" width:300px;"><input type="text" name="exp_leader[]" class="form-control" ></td>
                            <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word">មុនតំណែងអ្នកគ្រប់គ្រងផ្ទាល់</p></td>
                            <td class="style_td" colspan="2"><input type="text" name="exp_leader_position[]" class="form-control" ></td>
                      </tr>
                       <tr>
                            <td class="style_td"style=" width:200px;text-align:right;background:#dfe6e9;"><p​ class="word"><b>មូលហេតុនៃការចាកចេញ</b></p></td>
                           <td class="style_td" colspan="4" ><input type="text" name="exp_leave_reason[]" class="form-control" ></td>
                       </tr>
                       <tr>
                            <td class="style_td"​ colspan="5" style=" width:200px;text-align:center;background:#dfe6e9;"><p​ class="word"><b>រៀបរាប់ពីតួនាទី ភារកិច្ច និងការទទួលខុសត្រូវ</p></p></td>
                        </tr>
                       <tr>
            ...
            <div class="col-12"  style="margin-top:10px">
                <table class="table " border=1 style="border-color: black;" >
                    ...
                    <tr>
                        <td class="style_td" rowspan="2" style=" width:230px;text-align:center;background:#dfe6e9;"><p​ class="word">ភាសាបរទេស</p></td>
                        <td class="style_td"  colspan="4" style="​text-align:center;background:#dfe6e9;"><p​ class="word">ការសរសេ</p></td>
                        <td class="style_td"  colspan="4" style="text-align:center;background:#dfe6e9;"><p​ class="word">ការនិយាយ</p></td>
                        <td class="style_td"  colspan="4" style="text-align:center;background:#dfe6e9;"><p​ class="word">ការអាន</p></td>
                        <td class="style_td"  colspan="4" style="text-align:center;background:#dfe6e9;"><p​ class="word">ការស្តាប់</p></td>



                    </tr>
                    <tr>
                        <td class="style_td" style="text-align:center;background:#dfe6e9;"><p​ class="word">Ex</p></td>
                        <td class="style_td" style="text-align:center;background:#dfe6e9;"><p​ class="word">G</p></td>
                        <td class="style_td" style="text-align:center;background:#dfe6e9;"><p​ class="word">F</p></td>
                        <td class="style_td" style="text-align:center;background:#dfe6e9;"><p​ class="word">P</p></td>
            ...
            <div class="col-12" style="margin-top:10px">
                <table class="table " border=1 style="border-color: black;" >
                    <tr>
                        <td class="style_td" style="background:#dfe6e9; "><p class="word"> ហត្ថលេខា</p> </td>
                        <td class="style_td"​ colspan="3" >
                            <input type="text" name="" id="" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td class="style_td" style="background:#dfe6e9; "><p class="word"> ឈ្មោះ</p> </td>
                        <td class="style_td" style=""><input type="text" name="" id="" class="form-control"></td>
                        <td class="style_td" style="background:#dfe6e9; "><p class="word"> កាលបរិច្ឆេទ</p> </td>
...
<script type="text/javascript">
    function map() {
        var pointLatLng = new google.maps.LatLng(11.5812192, 104.8893527), marker, map;
