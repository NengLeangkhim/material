...
<div class="row" style="margin-top: 10px">
 ...
 <input type="hidden" name="erid" value="<?php echo (isset($_GET['erid']))?$_GET['erid']:'';?>">
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="during">
                <blockquote class="during" style="margin-left: 28px;">អាស្រ័យដូចបានជម្រាបជូន​ខាងលើ សូម​ លោកអគ្គនាយក  មេត្តាអនុញ្ញាតផ្តល់ខ្ញុំបាទនូវលិខិត បញ្ជាក់ការងារ ដើម្បីយកទៅប្រើប្រាស់ក្នុងគោលបំណង​ខាងលើ ដោយក្តីអនុគ្រោះ ។ </blockquote>
