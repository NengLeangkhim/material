...
<form action="controller/insert_fromemployment.php" method="post">
    ...
    <div class="row" style="margin-top:10px">
        <div class="col-12">
            <div class="row">
                <div class="col-1">
                    <p class="inputemploymentkh">1 - </p>
                </div>
                <div class="col-1">
                    <div class="row">
                        <p class="inputemploymentkh">នាមត្រកូល និងនាមខ្លួន :</p>
                        <p class="inputemploymenten">Full Name :</p>
                    </div>
                </div>
                <div class="col-2">
                    <!-- <div class="row"> -->
                ...
                <div class="col-2">
                    ...
                    <p class="inputemploymenten">Name in Latin :</p>
                </div>
                <div class="col-2">
                    <div class="row">
                ...
                <!-- <div class="col-2">
                     <img src=""  alt=""  id="preview" class="img-tdumbnail" style="width:150px;height:160px;"> -->
    ...
    <div class="row" ><!--style="transform: translateY(-40px);"-->
        <div class="col-12">
            <div class="row">
                <div class="col-1">
                    <p class="inputinfokh"></p>
                </div>
                <div class="col-1">
                    <div class="row">
                        <p class="inputemploymentkh">ថ្ងៃ ខែឆ្នាំកំណើត:</p></br>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <div class="row">
                        ...
                        <p class="inputemploymenten" style="margin-left: -95px; margin-top:10px">Marital Satatus :</p>
                    </div>
                </div>
                <div class="col-3" >
                   <label >
    ...
    <div class="row" >
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-2">
                    <div class="row">
                        <input type="text" name="birth_village" class="form-control" value="<?php echo (isset($v0))?$v0['birth_village']:'';?>" <?php echo $d1;?>>
                    </div>
                </div>
                <div class="col-1">
    ...
    <div class="row" >
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-2">
                    <div class="row">
                        <p class="inputemploymentkh">លេខទូរសព្ទផ្ទាល់ខ្លួន / Personal Telephone:</p>
                    </div>
                </div>
                <div class="col-9" >
    ...
    <div class="row"  style="margin-top:10px ">
        <div class="col-12">
            <div class="row">
                <div class="col-1">
                    <p class="inputemploymentkh">4 -</p>
                </div>
                <div class="col-1">
                    <div class="row">
                        <p class="inputemploymentkh">កម្រិតវប្បធម៌ / Education:</p>
                ...
                <div class="col-1">
                    <div class="row">
                        <p class="inputemploymentkh">ជំនាញ / Major :</p>
                    </div>
                </div>
                <div class="col-1">
                ...
                <div class="col-2">
                    <div class="row">
                        <p class="inputemploymentkh">ឈ្មោះគ្រឺះស្ថានសិក្សា / Name of School or University: <br></p>
                        <p class="inputemploymenten"></p>
                    </div>
                </div>
                <div class="col-1">
    ...
    <div class="row" >
        <div class="col-12">
            <div class="row">
                <div class="col-1">
                    <p class="inputemploymentkh">5 -</p>
                </div>
                <div class="col-2">
                    <div class="row">
                        <p class="inputemploymentkh">ចំណេះដឺងភាសាបរទេស</p>
                        <p class="inputemploymenten" style="margin-top:10px;margin-left:-133px">Language Skill </p>
                    </div>
                </div>
                <div class="col-9">
    ...
    <div class="row" >
        <div class="col-12">
            <div class="row">
                <div class="col-1">
                    <p class="inputemploymentkh">10 -</p>
                </div>
                <div class="col-8">
    ...
    <div class="row" >
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-10" >
                    <table class="table " border=1 style="text-aling:center">
                        <tr>
    ...
    <div class="row" style="margin-top:10px">
        <div class="col-12">
            <div class="row">
                <div class="col-1">
                    <p class="inputemploymentkh">12 - </p>
                </div>
                <div class="col-1">
                ...
                <div class="col-1">
                    ...
                    <p class="inputemploymenten">Year: </p>
                </div>
                <div class="col-2" >
                   <label >
                        <input type="radio"  name="father_stat" id="father_stat" value="live" <?php echo (isset($father))?(($father['parent_dead_live']=='live')?'checked':''):'';?> <?php echo $d;?>>
                            <div style="float:right;">
                            <p class="inputinfokh"> រស់  </p>
                            <p style="margin-top: -20px;">Living</p>
                        </div>
                   </label>
                </div>
                <div class="col-2" >
                   <label >
                        <input type="radio"  name="father_stat" id="father_stat" value="dead" <?php echo (isset($father))?(($father['parent_dead_live']=='dead')?'checked':''):'';?> <?php echo $d;?>>
                            <div style="float:right;">
                            <p class="inputinfokh"> ស្លាប់</p>
                            <p style="margin-top: -20px;">Death</p>
                        </div>
                   </label>
                </div>
    ...
    <div class="row" style="margin-top:10px">
        <div class="col-12">
            <div class="row">
                <div class="col-1">
                    <p class="inputemploymentkh">13 - </p>
                </div>
                <div class="col-1">
                    <p class="inputemploymentkh">ម្តាយ </p>
                    <p class="inputemploymenten">Mather's name: </p>
                </div>
                <div class="col-2">
    ...
    <div class="row">
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-2">
                    <p class="inputemploymentkh">អាស័យដ្ឋានអចិន្រ្តៃយ៍ :</p>
                    <p class="inputemploymenten">Current Address :</p>
                </div>
                <div class="col-2">
