...
<form id="frm_ere_insert_equipment_request">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <p class="during"> ហត្ថលេខានៅលើទម្រង់នេះមានសេចក្តីបញ្ជាក់ថាបានទទួលឧបករណ៍ដែលមានរាយឈ្មោះខាងលើ ត្រូវបានដំឡើងដោយជោកជ័យជាស្ថាពរនៅកន្លែងអតិថិជន ហើយអតិថិជនត្រូវទទួលខុសត្រូវរាល់ការខូចខាត ឬក៏​បាត់បង់ឧបករណ៍ទាំងអស់នេះ </p>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-2">
