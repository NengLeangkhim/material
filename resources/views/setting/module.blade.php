                ...
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <h1 class="card-title hrm-title"><strong><i class="fas fas fa-users"></i> Modules</strong></h1>
                        <div class="col-md-12 text-right">
                            ...
                            <a href="#" class="btn bg-turbo-color" data-toggle="modal" data-target="#addModule"><i class="fas fas fa-plus"></i> Add Module</a>
                        </div>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                        <table class="table table-bordered" id="tbl_employee" style="width: 100%; white-space: nowrap">
                          <thead>
                            <tr>
                              <th style="">#</th>
                          ...
                          <tbody>
                              @foreach ($data as $item)
                                  <tr>
                                      ...
                                      <td>{{ $item->link }}</td>
                                      <td>{{ $item->sequence }}</td>
                                      <td style="text-align: center;">{{ $item->status =='1' ? "Yes" : "No" }}</td>
                                      <td style="text-align: center;">{{ $item->is_show=='1' ? "Yes" : "No" }}</td>
                                      <td><a onclick="edit({{$item->id}})"><i class="far fas fa-edit"></i></td>
                                  </tr>
                              @endforeach
                          </tbody>
                        </table>
                    ...
                    <form class="form-horizontal" action="add" method="POST">
                      @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" name="parent" id="parent" required onchange="getParent(this)">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" id="sequence" type="text" required name="sequence" placeholder="Sequence">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-2">Prefix Code</label>
                              <div class="col-md-4">
                                <input class="form-control" maxlength="3" minlength="3" id="prefix_code" type="text" disabled required name="prefix_code" placeholder="prefix code">
                            </div>

                            <label class="control-label col-md-2">IS SHOW</label>
                            <div class="form-check">
                                <input class="form-check-input" name="show" type="radio" value="t" id="show" checked>
                                <label class="form-check-label" for="defaultCheck1">
                                    Yes
                                </label>
                            </div>&nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="form-check">
                                <input class="form-check-input" name="show" type="radio" value="f" id="show">
                                <label class="form-check-label" for="defaultCheck1">
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select size="4" class="form-control fas fa-select" id="icon" required name="icon" >
                        ...
                        <div class="form-group row">
                              ...
                              <div class="modal-footer">
                                  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" data-dismiss="modal" href="#"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                              </div>
                      </form>
                  </div>
                </div>
                    ...
                    <form class="form-horizontal" action="update/module" method="POST">
                      @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <label class="control-label col-md-2">Parent</label>
                            <div class="col-md-4">
                                <select disabled class="form-control select2"​ name="editParent" id="editparent" onchange="getParent(this)">
                                    <option value="" selected hidden disabled></option>
                                    <option value="null">null</option>
                                    @foreach ($parents as $item)
                                    <option value="{{ $item->id }}">{{ $item->name }}</option>
