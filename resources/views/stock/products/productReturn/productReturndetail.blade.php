    ...
    <div class="container-fluid">
        <div>
            <section class="content-header">
                    <h2>
                        <a href="javascript:void(0);"><img src="img/customerProduct.png" height="30" class="img-circle img-bordered-sm" alt="User Image">Product Return Detail</a>
                    </h2>
            </section>
        </div>
    </div>
        <div class="pull-right" style="margin-top: -1.3%;">
            <a  href="javascript:void(0);" onclick="go_to('productReturn')" class="text-info"><i class="fa fa-arrow-left"></i> Back</a> |
        ...
        <div class="box-body">
                    <div class="pro-detail-head col-md-9">
                        ...
                        <span class="text-primary">Return By</span>:{{$plist[0][0]->_by}}</h4>
                        <h4 style="margin-top: 0px;">
