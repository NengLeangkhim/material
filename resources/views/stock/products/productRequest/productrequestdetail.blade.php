    ...
    <div class="container-fluid">
        <div>
            <section class="content-header">
                    <h2>
                        <a  href="javascript:void(0);"><img src="img/customerProduct.png" height="30" class="img-circle img-bordered-sm" alt="User Image">Product Request Detail</a>
                    </h2>
            </section>
        </div>
    </div>
        <div class="pull-right" style="margin-top: -1.3%;">
            <a  href="javascript:void(0);" onclick="go_to('ProductRequest')" class="text-info"><i class="fa fa-arrow-left"></i> Back</a> |
        ...
        <div class="box-body">
                    <div class="pro-detail-head col-md-9">
                        ...
                        <span class="text-primary">Request By</span>:{{$plist[0][0]->_by}}</h4>
                        <h4 style="margin-top: 0px;">
                            <span class="text-primary">Approve By</span>: {{$plist[0][0]->approve_by}}<br>
                        </h4>
                        <h4 style="margin-top: 0px;">
                            <span class="text-primary">Request Date</span>: {{ date_format(date_create($plist[0][0]->request_date), 'd-M-Y h:i:s A')}}<br>
                        </h4>
                        <h4 style="margin-top: 0px;">
