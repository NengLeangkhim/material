                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-12 text_right">
                                <a href="javascript:" class="btn btn-success" onclick="go_to('bsc_customer_deposit_form/1')">Increase Deposit</a>
                                <a href="javascript:" class="btn btn-info" onclick="go_to('bsc_customer_deposit_transfer_form/1')">Transfer Deposit to Balance</a>
                                <a href="javascript:" class="btn btn-primary" onclick="go_to('bsc_customer_deposit_edit/1')">Edit Deposit</a>
                                <a href="javascript:" class="btn btn-danger" onclick="go_to('bsc_customer_deposit_refund_form/1')">Refund Deposit</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label for="current_deposit">Current Deposit</label>
                                            <div style="padding-left: 10px">
                                                <label for="">: </label>
                                            </div>
                                        </div>
