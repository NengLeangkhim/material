            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="new_cus" role="tabpanel" aria-labelledby="home-tab">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="all_connection" class="table table-bordered table-striped" style="white-space: nowrap">
                                        <thead>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive" style="padding-left: 20px;padding-top: 20px">
                                        <table id="news_connection" class="table table-bordered table-striped" style="white-space: nowrap">
                                            <thead>
                                                <tr class="background_color_tr">
                                                    <th class="background_color_td">No</th>
                                                    <th class="background_color_td">CID</th>
                        ...
                        <div class="tab-pane fade" id="suspend_cus" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="tab-content" id="myTabContent">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive" style="padding-left: 20px;padding-top: 20px">
                                        <table id="my_active_connection" class="table table-bordered table-striped" style="white-space: nowrap">
                                            <thead>
                                                <tr class="background_color_tr">
                                                    <th class="background_color_td">No</th>
                                                    <th class="background_color_td">CID</th>
                        ...
                        <div class="tab-pane fade" id="locked_cus" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="tab-content" id="myTabContent">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive" style="padding-left: 20px;padding-top: 20px">
                                        <table id="my_close_connection" class="table table-bordered table-striped" style="white-space: nowrap">
                                            <thead>
                                                <tr class="background_color_tr">
                                                    <th class="background_color_td">No</th>
                                                    <th class="background_color_td">CID</th>
                        ...
                        <div class="tab-pane fade" id="locked_cus" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="tab-content" id="myTabContent">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive" style="padding-left: 20px;padding-top: 20px">
                                        <table id="my_suspend_connection" class="table table-bordered table-striped" style="white-space: nowrap">
                                            <thead>
                                                <tr class="background_color_tr">
                                                    <th class="background_color_td">No</th>
                                                    <th class="background_color_td">CID</th>
                        ...
                        {{-- ========================== end tab Connection Suspend =========================== --}}

                        {{-- ========================== start tab Connection Locked =========================== --}}
                        <div class="tab-pane fade" id="locked_cus" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="tab-content" id="myTabContent">
                                <div class="card-body">
                                    <div class="form-group">
                                    ...
                                    <div class="table-responsive" style="padding-left: 20px;padding-top: 20px">
                                        <table id="my_lock_connection" class="table table-bordered table-striped" style="white-space: nowrap">
                                            <thead>
                                                <tr class="background_color_tr">
                                                    <th class="background_color_td">No</th>
                                                    <th class="background_color_td">CID</th>
                        ...
                        {{-- ========================== end tab Connection Locked =========================== --}}

                        {{-- ========================== start tab Connection Unpaid =========================== --}}
                        <div class="tab-pane fade" id="locked_cus" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="tab-content" id="myTabContent">
                                <div class="card-body">
                                    <div class="form-group">
...
$(function () {
    ...
    $("#my_active_connection").DataTable({
        "scrollX":true,
        "autoWidth": false,
        "scrollY": "400px",
        "scrollCollapse": false
    ...
    $('#my_suspend_connection').DataTable({
        "scrollX":true,
        "autoWidth": false,
        "scrollY": "400px",
        "scrollCollapse": false
