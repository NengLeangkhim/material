<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-4">
                <h1><span><i class="fas fa-dollar-sign"></i></span> Update Balance</h1>
            </div>
            <div class="col-md-5">
                ...
                <form id="frm_increase_balance" action="">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary update" id="frm_btn_sub_balance" onclick="UpdateData()">Update</button>
