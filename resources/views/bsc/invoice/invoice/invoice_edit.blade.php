                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input_required" name="customer" id="customer" data-customer_id placeholder="Customer" value="{{ $invoices->customer_name }}" readonly>
                                        </div>
                                    </div>
