                ...
                <div class="card" >
                    <div class="card-header p-2">
                        <ul class="nav nav-pills" id="custom-tabs-one-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:void(0);" onclick="CrmSurveyView('/crm/survey/list','surveyListTbl')" data-toggle="tab">List Survey</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0);" onclick="CrmSurveyView('/crm/survey/result','surveyResultTbl')" data-toggle="tab">Survey Result</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                            <div class="tab-Setting">
                                <div class="row" id="CrmTabManageSurvey">
...
<script type="text/javascript">
    ...
    // $(function () {
    //     $("#surveyListTbl").DataTable({
    //         // "responsive": true,
    //         "autoWidth": false,
    //         "scrollY":true,
    //         "scrollX": '400px',
    //     });
    //     $("#surveyResultTbl").DataTable({
    //         // "responsive": true,
    //         "autoWidth": false,
    //         "scrollX": true,
    //         "scrollY": '400px',
    ...
    // $('#custom-tabs-one-profile-tab').on('click',()=>{
    // })
