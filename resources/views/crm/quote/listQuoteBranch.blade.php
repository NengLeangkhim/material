    ...
    <div class="modal-dialog modal-lg" id="confirm_box1">
        <div class="modal-content">
                <div class=" modal-header text-center">
                    <h4 class="modal-title" id="exampleModalLabel"><b>Select Customer Branch</b></h4>
                    <button type="button" onclick="closeModalUp('listQuoteBranch')" class="close" data-dismiss="modal">×</button>
                </div>
