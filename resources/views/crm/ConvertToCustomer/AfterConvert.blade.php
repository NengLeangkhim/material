...
<div class="col-md-12">
    <div>
        <div class="tab-pane fade show" id="custom-tabs-after-convert" role="tabpanel" aria-labelledby="custom-tabs-one-tabContent">
            <table id="After_Convert_Tbl" class="table table-bordered table-striped" style="width:100%; white-space: nowrap;">
                <thead>
