...
<!-- modal Insert-->
<form id="crm_quote_status_form">
    <div class="modal fade show" id="crm_quote_status_modal" tabindex="-1" role="dialog" aria-labelledby="crm_quote_status_modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title hrm-title"><strong><i class="fas fa-plus"></i></strong></h3>
                    <h2 class="card-title hrm-title" style="font-weight: bold;font-size:25px" id="card_title">Add Quote Status</h2>
                ...
                <div class="card-body" style="display: block;">
                     ...
                     <div class="row text-right">
                        <div class="col-md-12 text-right">
                          <input type="hidden" name="id" id="quote_status_id"/>
                          <button type="button" onclick='CrmSubmitModalAction("crm_quote_status_form","ActionQuoteStatus","/crm/setting/quotestatus/store","POST","crm_quote_status_modal","Successfully","/crm/setting")' name="ActionQuoteStatus" id="ActionQuoteStatus"  class="btn btn-primary">Create</button>
                        </div>
                     </div>
                </div><!-- /.END card-body -->
