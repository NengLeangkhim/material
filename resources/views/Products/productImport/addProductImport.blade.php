 ...
 <div class="right_col" role="main">
    <div class="container-fluid">
        ...
        <div>
            ...
            <form name="addproductimport" action="/addProductImport" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                            <select name="company" id="icompany" class="form-control" onchange="getbranch(this,'company_branch','s','/getcompany');clear_row()" required>
                                @php
