 ...
 <div class="right_col" role="main">
    <div class="container-fluid">
        <section class="content-header">
            <h2>
                <a  href="javascript:void(0);"><img src="img/customerProduct.png" height="30" class="img-circle img-bordered-sm" alt="User Image">Add Product Request</a>
            </h2>
        </section>
            {{-- <div style="width:100%;height:8px;background-color:#3c8dbc;margin-bottom:10px"></div> --}}

            <form name="addproductrequest" id="frm_addprequest" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="action_type" id='action_type' value="out">
            {{-- <div class="container-fluid"> --}}
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label>Request By<i class="text-danger">*</i> </label>
                            <div class="input-group">
...
<script type="text/javascript">
    $(document).ready(
        function(){
            getbranch(document.addproductrequest.company,'company_branch','s','/getcompany');
            get_product('','tbody_a',1);
        }
    );
    $('#frm_btn_subaddprequest').click( function(){
        ...
        if(tbody.rows.length<1){
            ...
            submit_form('/addProductRequest','frm_addprequest','ProductRequest');
        }
    });
