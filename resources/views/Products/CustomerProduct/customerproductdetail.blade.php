@php
    if($plist[0][0]->action_type=='out'){
        $re='Request By';
        $d='Request Date';
    }elseif($plist[0][0]->action_type=='return'){
        $re='Return By';
        $d='Return Date';
    }
@endphp
    ...
    <div class="container-fluid">
        <div>
            <section class="content-header">
                    <h2>
                        <a  href="javascript:void(0);"><img src="img/customerProduct.png" height="30" class="img-circle img-bordered-sm" alt="User Image"> Product Customer Detail</a>
                    </h2>
            </section>
        </div>
    </div>
        ...
        <div class="box-body">
                    <div class="pro-detail-head col-md-9">
                        <h4 style="margin-top: 0px;">
                            <span class="text-danger">Customer Name</span>: {{$plist[0][0]->customer}}<br>
                        </h4>
                        <h4 style="margin-top: 0px;">
                            <span class="text-danger">Branch</span>: {{$plist[0][0]->branch}}<br>
                        </h4>
                        <h4 style="margin-top: 0px;">
                        <span class="text-primary">{{$re}}</span>:{{$plist[0][0]->_by}}                        </h4>
                        <h4 style="margin-top: 0px;">
                            <span class="text-primary">Approve By</span>: {{$plist[0][0]->approve_by}}<br>
                        </h4>
                        <h4 style="margin-top: 0px;">
                            <span class="text-primary">{{$d}}</span>: {{ date_format(date_create($plist[0][0]->request_date), 'd-M-Y h:i:s A')}}<br>
                        </h4>
                        <h4 style="margin-top: 0px;">
