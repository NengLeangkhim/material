                    ...
                    @foreach ($attendance[8] as $e)
                        ...
                        <td>
                          <div class="row">
                            ...
                            <div class="col-md-6"><a href="javascript:;" onclick="HRM_ShowDetail('hrm_attendance_detail','modal_attendance_detail',{{$e[0] ?? 0}},'tbl_hrm_attendance_detail')"><i class="fas fa-info"></i></a></div>
                          </div>
                        </td>
                      <th>{{++$i}}</th>
                      <td>{{$e[1]}}</td>
