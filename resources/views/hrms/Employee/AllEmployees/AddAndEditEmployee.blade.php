          ...
          <div class="card-body" style="display: block;">
            ...
            {{-- <div class="col-md-3 text-center border">
                <div class="col-md-12 text-center" style="width: 100%">
                    <div style="width:250px;height:300px" class="border text-center" id="uploaded_image">
                        <img id="output_image" name="emProfile" height="300px" width="250px" src="@php if(isset($data[1])){ echo $data[1]['image'];} @endphp"/>
                    </div>
                    <br>
                    <input type="file" name="emProfile" id="upload_image" onchange="preview_image(event)">
                </div>
