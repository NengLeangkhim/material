            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success) {
                        ...
                        sweetalert('warning', 'Delete failed!');
                    } else {
                        sweetalert('warning', data);
                    }
                }
...
$(document).on('click', '#btnUpdateQuoteLead', function() {
    ...
    $.ajax({
        ...
        data: $('#frmEditQuoteLead').serialize(),
        success: function(data) {
...
$(document).on('click', '#btnUpdateQuoteBranch', function() {
    ...
    $.ajax({
        ...
        data: $('#frmEditQuoteBranch' + branId + '').serialize(),
        success: function(data) {
